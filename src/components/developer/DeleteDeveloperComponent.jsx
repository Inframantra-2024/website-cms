...
import { fetchDeveloperData, deleteDeveloper } from '../../features/developer/developerSlice';
...
const DeleteDeveloperComponent = ({ stateId, closeModal }) => {
  ...
  const states1 = useSelector(state => state.developer.data); // Adjust based on your state slice structure
  ...
  const handleDeleteState = async () => {
    try {
      await dispatch(deleteDeveloper(selectedState._id));
  ...
  return (
    <div className="container mt-4">
      <div className='section-header text-center mb-5 text-uppercase'>
         <h4 className='text-center bg-primary text-white p-3 text-uppercase'>Delete Developer</h4>
      </div>
      <div className="mb-3 ">
        <label htmlFor="searchQuery" className="form-label text-center">Search Developer</label>
        <input
          type="text"
      ...
      {selectedState && (
        <div>
          <div className="mb-3">
            <label htmlFor="selectedStateName" className="form-label">Selected Developer Name</label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="mb-3">
            <label htmlFor="selectedStateId" className="form-label">Selected Developer ID</label>
            <input
              type="text"
              className="form-control"
              id="selectedStateId"
